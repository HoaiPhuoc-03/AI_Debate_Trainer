...
class FrontendAuthBindingTests(unittest.TestCase):
    ...
    def test_frontend_arena_includes_practice_mode_bar(self):
        ...
        self.assertIn('quick_rebuttal: ["claim", "evidence", "reasoning", "focus"]', html)
        ...
        self.assertIn('focus: "Đúng trọng tâm"', html)
        self.assertIn("focus: modeScores.focus", html)
        self.assertIn("focus: toScore(displayCer.focus)", html)
        self.assertIn('["focus", metricLabelFor("focus"), cer.focus, "focus"]', html)
        self.assertIn('id="arena-focus-metric"', html)
        self.assertIn('id="arena-focus-bar"', html)
        self.assertIn(".score-tiles--quick", html)
        self.assertIn('state.mode === "quick_rebuttal" ? "score-tiles--quick" : ""', html)
    ...
    def test_frontend_practice_round_flow_is_wired(self):
        ...
        self.assertIn("currentFallacyHint: \"\"", html)
        self.assertIn("currentTargetFlaws: []", html)
        ...
        self.assertIn("body.practice_fallacy_hint = state.practice.currentFallacyHint", html)
        self.assertIn("body.practice_target_flaws = state.practice.currentTargetFlaws", html)
    ...
    def test_quick_rebuttal_label_is_rendered_once_by_frontend(self):
        ...
        self.assertIn("Hãy chỉ ra lỗ hổng, giả định sai hoặc phản ví dụ...", html)
    ...
    def test_frontend_arena_shows_user_and_lumi_stance_badges(self):
        ...
        self.assertIn('const isQuickRebuttalMode = getActivePracticeMode() === "quick_rebuttal"', html)
        self.assertIn('userBadge.classList.add("hidden")', html)
        self.assertIn('lumiBadge.classList.add("hidden")', html)
    ...
    def test_frontend_login_uses_generated_dragon_battle_background(self):
        ...
        self.assertIn('src="assets/lumi-logo.png"', html)
        self.assertTrue((ROOT_DIR / "frontend" / "assets" / "lumi-logo.png").exists())
